...
export default {
  ...
  methods: {
    ...
    async loginWithMicrosoft() {
      ...
      try {
        console.log('🔄 Iniciando Microsoft Sign-In con selector de cuentas...');
        ...
        try {
          if (this.$microsoftAuth && typeof this.$microsoftAuth.signIn === 'function') {
            ...
            console.log('✅ Usuario seleccionó cuenta de Microsoft:', microsoftUser);
        ...
        // Mostrar mensaje de éxito personalizado
        const welcomeMessage = usingRealAuth 
          ? `¡Bienvenido ${profile.getName()}! Has iniciado sesión con tu cuenta de Microsoft.`
          : `¡Bienvenido ${profile.getName()}! Conectado con Microsoft (modo demo).`;
        ...
        console.error('❌ Error completo de Microsoft Auth:', error);
        
        // Mensaje de error específico
        let errorMessage = 'Hubo un problema con el inicio de sesión de Microsoft.';
